// Tüketiciler (web/ajan/Deno paketi) bu paketin tsconfig include listesini görmez: kütüphanenin tip bildirimi
// buradan referansla programa katılır. import biçimi mümkün değil (ambient `declare module`, dışa aktarım yok).
// eslint-disable-next-line @typescript-eslint/triple-slash-reference
/// <reference path="./receipt-printer-encoder.d.ts" />
// ESC/POS fiş kodlayıcı — yazdırma ajanı, Epson SDP (Deno paketi) ve yerel uygulamadaki tablet istasyonu
// (web) AYNI kodu kullanır. Yalnız tarayıcı uyumlu @point-of-sale/* paketlerine bağlıdır: node: içe aktarımı YOK.
import type { Line } from './ticket';
